...
packages. The designed circuits are simulated in the software and tested. Testing
includes the expected conditions of the inputs and verifying that expected outputs
are returned. Edge cases are simulated to verify safety and failure conditions of
the circuits. 
\newline
\newline
...
based on their perspective. This tests the quality of writing and functionality of 
the code. 
...
Inputs will be powered via the power and readings are verified for correctness relative 
to the power supply. Outputs are verified using the voltemeter to measure. 
Finally, sensors and circuits are tested using the IO of the microcontroller. This allows
...
sub-systems can begin to combine to test completness of full systems. 
