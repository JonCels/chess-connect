...
\begin{itemize}
  ...
  \item \textbf{Unit Tests:} Detailed in \hyperref[UnitTests]{Section \ref*{UnitTests}}, unit tests will be performed for Python and Javascript code.
    \begin{itemize}
      \item \href{https://github.com/testing-library/react-testing-library}{React Testing Library} will be used for Javascript
      \item \href{https://docs.pytest.org/en/7.2.x/}{PyTest} will be used for Python
    \end{itemize}

  \item \textbf{Dynamic Analysis Tool:} Rather than creating unit tests for the C code, memory leaks and access errors will be caught using \href{https://valgrind.org/}{ValGrind}.
\end{itemize}

In addition to the automated testing, dynamic analysis will be performed on the hardware to debug and verify the C code. The debugging platform used is \href{https://www.google.com}{idk}.
