...
\begin{enumerate}
    \item{NFT4}
        ...
        suspend hold it. The system will give visual indicators of where the held piece is able to move according to the rules of chess. The time between when 
    ...
    \item{NFT5}
        ...
        How test will be performed: The times measured in the previous test, NFT4, will be inspected. The maximum recorded individual time must be less than 10 seconds.
\end{enumerate}
