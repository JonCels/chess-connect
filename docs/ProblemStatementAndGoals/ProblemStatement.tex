...
\medskip
\noindent{In terms of the hardware, we are planning to use --- for the micro-controller and --- for the display, where our method of connecting the hardware and software together will be Bluetooth. 
