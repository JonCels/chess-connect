...
\medskip
\noindent{In terms of the hardware, we are planning to use sensors to track pieces on the board using a microcontroller that will be programmed in C. An LCD display will show engine moves, where our method of connecting the hardware and software together will be Bluetooth. 
