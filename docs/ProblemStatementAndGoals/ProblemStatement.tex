...
\medskip
\noindent{This project plans to centralize these two mediums of studying the game in order to provide flexibility and remove constraints for new players in learning how to play chess.}
...
\medskip
\noindent{In terms of the hardware, we are planning to use sensors to track pieces on the board using a micro-controller that will be programmed in C. An LCD display will show engine moves, where our method of connecting the hardware and software together will be Bluetooth. 
Thode Makerspace will be utilized as a workspace to build the project.}
