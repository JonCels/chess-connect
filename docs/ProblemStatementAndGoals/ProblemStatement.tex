...
\medskip
\noindent{The micro-controller will be programmed in C, and the engine moves will be displayed on an LCD display. Thode Makerspace will be utilized as a workspace to build the project.}
