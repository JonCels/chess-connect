...
\begin{enumerate}[{NB}1., leftmargin=2\parindent]
    ...
    \item Allow each player the ability to resign by holding down the Resign/Draw button for ENDTIME seconds located on the LCD screen.
    \item Allow the players the ability to draw by having them both hold down the Resign/Draw button for ENDTIME seconds located on the LCD screen.  
\end{enumerate}
