...
\multirow{3}{0.3\textwidth}{Arduino Controller Module} & Piece Identification Module \\
& Chess Board Module\\
...
\subsubsection{Arduino Controller Module}
\begin{description}
\item[Secrets:] The logic for changing game state and reading user actions.
\item[Services:] Reads inputs from sensors and communication pins. Writes to outputs to turn on/off LED's and communicate information to the Teensy Controller and Web Application.
\item[Implemented By:] Arduino Mega 2560 Rev3 Controller
\end{description}

\subsubsection{Piece Identification Module}
\begin{description}
...
\subsubsection{Chess Board Module}
\begin{description}
