...
\end{description}
    ...
    \subsubsection{Teensy Input from Mega Module \mref{TeensyToMegaRx}} 
    \begin{description}
    \item[Secrets:] None.
    \item[Services:] Receives game state information from the Arduino Mega in the form of a FEN string. 
    \item[Implemented By:] \progname\ (Serial Communication)
    \end{description}

    \subsubsection{Teensy Input Bluetooth from Web Application Module \mref{TeensyToWaRx}} 
    \begin{description}
    \item[Secrets:] None.
    \item[Services:] Receives check, mate and draw info from the web application and best move information.
    \item[Implemented By:] \progname\ (Serial Communication, Bluetooth)
    \end{description}

    \subsubsection{Teensy Output Bluetooth to Web Application Module \mref{TeensyToWaTx}} 
    \begin{description}
    \item[Secrets:] FEN String of Game State and game mode
    \item[Services:] Collects game state and mode from the board and send to Web Application
    \item[Implemented By:] \progname\ (Serial Communication, Bluetooth)
    \end{description}
