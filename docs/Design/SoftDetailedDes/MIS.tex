...
\section{MIS of PieceIdentification Module} \label{PieceIdentificationModule}

\subsection{PieceIdentification}
...
\section{MIS of ChessBoard Module} \label{ChessBoardModule} 
