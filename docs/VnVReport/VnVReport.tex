...
\begin{table}[H]
  \centering
      ...
      \hline
      GA-1 & rnbqkbnr/\-pppppppp\-/8/8/8/8/\-PPPPPPPP/\-RNBQKBNR w KQkq - 0 1 & false & false & Pass \\
      \hline
      \end{tabular}
\end{table}

\begin{verbatim}
  boolean inCheckmate(string fenString)
\end{verbatim}
...
\begin{table}[H]
  \centering
      ...
      Test & Input & Expected & Actual & Result\\
      \hline
      GA-1 & rnb1kbnr/\-pppp1ppp\-/8/4p3\-/5PPq/8/\-PPPPP2P/\-RNBQKBNR \-w KQkq - 1 3 & true & true & Pass \\
      \hline
      \end{tabular}
\end{table}
