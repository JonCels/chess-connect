...
\begin{table}[H]
  ...
  \setlength{\leftmargini}{0cm}
      ...
      \hline
      Function & 61 &  &  & A list of all functions covered can be found in \hyperref[FunctionsCovered]{Appendix \ref{FunctionsCovered}} \\
      \hline
      Path &  &  &  & A list of all paths considered can be found in \hyperref[CodePaths]{Appendix \ref{CodePaths}} \\
      \hline
      \end{tabular}
...
\begin{itemize}
  ...
  \item btComm
  \item appendCharToStr
  \item makeEngineBox
  \item setEngineBoxText
  \item makeStartButton
  \item makeWhiteResignButton
  \item makeDrawButton
  \item makeBlackResignButton
  \item makeGameModeButtons
  \item selectNormalMode
  \item selectEngineMode
  \item selectBeginnerMode
  \item resignGame
  \item drawGame
  \item startGame
...
\begin{itemize}
  ...
  \item[\checkmark] move white pawn from start
  \item[\checkmark] move black bishop from random square
  \item[\checkmark] move black knight from random square
  \item[\checkmark] move white queen from random square
  \item[\checkmark] move black king from random square
