...
\begin{enumerate}[{PRR}1., leftmargin=2\parindent, resume]
    \item Example
\end{enumerate}

\subsection{Audit Requirements}
\begin{enumerate}[{ADR}1., leftmargin=2\parindent, resume]
    \item Example
\end{enumerate}

\subsection{Immunity Requirements}
\begin{enumerate}[{IMR}1., leftmargin=2\parindent, resume]
    \item Example
\end{enumerate}
\section{Roadmap}
